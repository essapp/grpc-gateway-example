...
const file_examples_internal_proto_sub2_message_proto_rawDesc = "" +
	"\n" +
	"*examples/internal/proto/sub2/message.proto\x12\x1cexamples.internal.proto.sub2\"\x1f\n" +
	"\tIdMessage\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuidBHZFgithub.com/essapp/grpc-gateway-example/v2/examples/internal/proto/sub2b\x06proto3"

var (
	file_examples_internal_proto_sub2_message_proto_rawDescOnce sync.Once
	file_examples_internal_proto_sub2_message_proto_rawDescData []byte
)
...
func file_examples_internal_proto_sub2_message_proto_rawDescGZIP() []byte {
	file_examples_internal_proto_sub2_message_proto_rawDescOnce.Do(func() {
		file_examples_internal_proto_sub2_message_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_examples_internal_proto_sub2_message_proto_rawDesc), len(file_examples_internal_proto_sub2_message_proto_rawDesc)))
	})
...
var file_examples_internal_proto_sub2_message_proto_goTypes = []any{
	(*IdMessage)(nil), // 0: examples.internal.proto.sub2.IdMessage
}
...
func file_examples_internal_proto_sub2_message_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_examples_internal_proto_sub2_message_proto_rawDesc), len(file_examples_internal_proto_sub2_message_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
