...
const (
	ServiceA_MethodOne_FullMethodName = "/examples.internal.examplepb.ServiceA/MethodOne"
	ServiceA_MethodTwo_FullMethodName = "/examples.internal.examplepb.ServiceA/MethodTwo"
)
...
func (UnimplementedServiceAServer) MethodOne(context.Context, *InMessageA) (*OutMessageA, error) {
	return nil, status.Error(codes.Unimplemented, "method MethodOne not implemented")
}
func (UnimplementedServiceAServer) MethodTwo(context.Context, *OutMessageA) (*InMessageA, error) {
	return nil, status.Error(codes.Unimplemented, "method MethodTwo not implemented")
}
...
var ServiceA_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.examplepb.ServiceA",
...
const (
	ServiceC_MethodOne_FullMethodName = "/examples.internal.examplepb.ServiceC/MethodOne"
	ServiceC_MethodTwo_FullMethodName = "/examples.internal.examplepb.ServiceC/MethodTwo"
)
...
var ServiceC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.examplepb.ServiceC",
