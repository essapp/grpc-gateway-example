...
const (
	EnumWithSingleValueService_Echo_FullMethodName = "/examples.internal.proto.examplepb.EnumWithSingleValueService/Echo"
)
...
func RegisterEnumWithSingleValueServiceServer(s grpc.ServiceRegistrar, srv EnumWithSingleValueServiceServer) {
	// If the following call panics, it indicates UnimplementedEnumWithSingleValueServiceServer was
...
var EnumWithSingleValueService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.EnumWithSingleValueService",
