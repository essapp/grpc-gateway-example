...
const (
	ABitOfEverythingService_Create_FullMethodName                        = "/examples.internal.proto.examplepb.ABitOfEverythingService/Create"
	ABitOfEverythingService_CreateBody_FullMethodName                    = "/examples.internal.proto.examplepb.ABitOfEverythingService/CreateBody"
	ABitOfEverythingService_CreateBook_FullMethodName                    = "/examples.internal.proto.examplepb.ABitOfEverythingService/CreateBook"
	ABitOfEverythingService_UpdateBook_FullMethodName                    = "/examples.internal.proto.examplepb.ABitOfEverythingService/UpdateBook"
	ABitOfEverythingService_Lookup_FullMethodName                        = "/examples.internal.proto.examplepb.ABitOfEverythingService/Lookup"
	ABitOfEverythingService_Custom_FullMethodName                        = "/examples.internal.proto.examplepb.ABitOfEverythingService/Custom"
	ABitOfEverythingService_DoubleColon_FullMethodName                   = "/examples.internal.proto.examplepb.ABitOfEverythingService/DoubleColon"
	ABitOfEverythingService_Update_FullMethodName                        = "/examples.internal.proto.examplepb.ABitOfEverythingService/Update"
	ABitOfEverythingService_UpdateV2_FullMethodName                      = "/examples.internal.proto.examplepb.ABitOfEverythingService/UpdateV2"
	ABitOfEverythingService_Delete_FullMethodName                        = "/examples.internal.proto.examplepb.ABitOfEverythingService/Delete"
	ABitOfEverythingService_GetQuery_FullMethodName                      = "/examples.internal.proto.examplepb.ABitOfEverythingService/GetQuery"
	ABitOfEverythingService_GetRepeatedQuery_FullMethodName              = "/examples.internal.proto.examplepb.ABitOfEverythingService/GetRepeatedQuery"
	ABitOfEverythingService_Echo_FullMethodName                          = "/examples.internal.proto.examplepb.ABitOfEverythingService/Echo"
	ABitOfEverythingService_DeepPathEcho_FullMethodName                  = "/examples.internal.proto.examplepb.ABitOfEverythingService/DeepPathEcho"
	ABitOfEverythingService_NoBindings_FullMethodName                    = "/examples.internal.proto.examplepb.ABitOfEverythingService/NoBindings"
	ABitOfEverythingService_Timeout_FullMethodName                       = "/examples.internal.proto.examplepb.ABitOfEverythingService/Timeout"
	ABitOfEverythingService_ErrorWithDetails_FullMethodName              = "/examples.internal.proto.examplepb.ABitOfEverythingService/ErrorWithDetails"
	ABitOfEverythingService_GetMessageWithBody_FullMethodName            = "/examples.internal.proto.examplepb.ABitOfEverythingService/GetMessageWithBody"
	ABitOfEverythingService_PostWithEmptyBody_FullMethodName             = "/examples.internal.proto.examplepb.ABitOfEverythingService/PostWithEmptyBody"
	ABitOfEverythingService_CheckGetQueryParams_FullMethodName           = "/examples.internal.proto.examplepb.ABitOfEverythingService/CheckGetQueryParams"
	ABitOfEverythingService_CheckNestedEnumGetQueryParams_FullMethodName = "/examples.internal.proto.examplepb.ABitOfEverythingService/CheckNestedEnumGetQueryParams"
	ABitOfEverythingService_CheckPostQueryParams_FullMethodName          = "/examples.internal.proto.examplepb.ABitOfEverythingService/CheckPostQueryParams"
	ABitOfEverythingService_OverwriteRequestContentType_FullMethodName   = "/examples.internal.proto.examplepb.ABitOfEverythingService/OverwriteRequestContentType"
	ABitOfEverythingService_OverwriteResponseContentType_FullMethodName  = "/examples.internal.proto.examplepb.ABitOfEverythingService/OverwriteResponseContentType"
	ABitOfEverythingService_CheckExternalPathEnum_FullMethodName         = "/examples.internal.proto.examplepb.ABitOfEverythingService/CheckExternalPathEnum"
	ABitOfEverythingService_CheckExternalNestedPathEnum_FullMethodName   = "/examples.internal.proto.examplepb.ABitOfEverythingService/CheckExternalNestedPathEnum"
	ABitOfEverythingService_CheckStatus_FullMethodName                   = "/examples.internal.proto.examplepb.ABitOfEverythingService/CheckStatus"
	ABitOfEverythingService_Exists_FullMethodName                        = "/examples.internal.proto.examplepb.ABitOfEverythingService/Exists"
	ABitOfEverythingService_CustomOptionsRequest_FullMethodName          = "/examples.internal.proto.examplepb.ABitOfEverythingService/CustomOptionsRequest"
	ABitOfEverythingService_TraceRequest_FullMethodName                  = "/examples.internal.proto.examplepb.ABitOfEverythingService/TraceRequest"
	ABitOfEverythingService_PostOneofEnum_FullMethodName                 = "/examples.internal.proto.examplepb.ABitOfEverythingService/PostOneofEnum"
	ABitOfEverythingService_PostRequiredMessageType_FullMethodName       = "/examples.internal.proto.examplepb.ABitOfEverythingService/PostRequiredMessageType"
)
...
func (UnimplementedABitOfEverythingServiceServer) CreateBody(context.Context, *ABitOfEverything) (*ABitOfEverything, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateBody not implemented")
}
...
func (UnimplementedABitOfEverythingServiceServer) Custom(context.Context, *ABitOfEverything) (*ABitOfEverything, error) {
	return nil, status.Error(codes.Unimplemented, "method Custom not implemented")
}
func (UnimplementedABitOfEverythingServiceServer) DoubleColon(context.Context, *ABitOfEverything) (*ABitOfEverything, error) {
	return nil, status.Error(codes.Unimplemented, "method DoubleColon not implemented")
}
...
func (UnimplementedABitOfEverythingServiceServer) UpdateV2(context.Context, *UpdateV2Request) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateV2 not implemented")
}
...
func (UnimplementedABitOfEverythingServiceServer) GetRepeatedQuery(context.Context, *ABitOfEverythingRepeated) (*ABitOfEverythingRepeated, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRepeatedQuery not implemented")
}
...
func (UnimplementedABitOfEverythingServiceServer) DeepPathEcho(context.Context, *ABitOfEverything) (*ABitOfEverything, error) {
	return nil, status.Error(codes.Unimplemented, "method DeepPathEcho not implemented")
}
func (UnimplementedABitOfEverythingServiceServer) NoBindings(context.Context, *durationpb.Duration) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method NoBindings not implemented")
}
...
func (UnimplementedABitOfEverythingServiceServer) ErrorWithDetails(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ErrorWithDetails not implemented")
}
func (UnimplementedABitOfEverythingServiceServer) GetMessageWithBody(context.Context, *MessageWithBody) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMessageWithBody not implemented")
}
func (UnimplementedABitOfEverythingServiceServer) PostWithEmptyBody(context.Context, *Body) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method PostWithEmptyBody not implemented")
}
func (UnimplementedABitOfEverythingServiceServer) CheckGetQueryParams(context.Context, *ABitOfEverything) (*ABitOfEverything, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckGetQueryParams not implemented")
}
func (UnimplementedABitOfEverythingServiceServer) CheckNestedEnumGetQueryParams(context.Context, *ABitOfEverything) (*ABitOfEverything, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckNestedEnumGetQueryParams not implemented")
}
func (UnimplementedABitOfEverythingServiceServer) CheckPostQueryParams(context.Context, *ABitOfEverything) (*ABitOfEverything, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckPostQueryParams not implemented")
}
func (UnimplementedABitOfEverythingServiceServer) OverwriteRequestContentType(context.Context, *Body) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method OverwriteRequestContentType not implemented")
}
func (UnimplementedABitOfEverythingServiceServer) OverwriteResponseContentType(context.Context, *emptypb.Empty) (*wrapperspb.StringValue, error) {
	return nil, status.Error(codes.Unimplemented, "method OverwriteResponseContentType not implemented")
}
func (UnimplementedABitOfEverythingServiceServer) CheckExternalPathEnum(context.Context, *pathenum.MessageWithPathEnum) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckExternalPathEnum not implemented")
}
func (UnimplementedABitOfEverythingServiceServer) CheckExternalNestedPathEnum(context.Context, *pathenum.MessageWithNestedPathEnum) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckExternalNestedPathEnum not implemented")
}
...
func (UnimplementedABitOfEverythingServiceServer) CustomOptionsRequest(context.Context, *ABitOfEverything) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method CustomOptionsRequest not implemented")
}
func (UnimplementedABitOfEverythingServiceServer) TraceRequest(context.Context, *ABitOfEverything) (*ABitOfEverything, error) {
	return nil, status.Error(codes.Unimplemented, "method TraceRequest not implemented")
}
func (UnimplementedABitOfEverythingServiceServer) PostOneofEnum(context.Context, *oneofenum.OneofEnumMessage) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method PostOneofEnum not implemented")
}
func (UnimplementedABitOfEverythingServiceServer) PostRequiredMessageType(context.Context, *RequiredMessageTypeRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method PostRequiredMessageType not implemented")
}
...
func RegisterABitOfEverythingServiceServer(s grpc.ServiceRegistrar, srv ABitOfEverythingServiceServer) {
	// If the following call panics, it indicates UnimplementedABitOfEverythingServiceServer was
...
var ABitOfEverythingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.ABitOfEverythingService",
...
const (
	CamelCaseServiceName_Empty_FullMethodName = "/examples.internal.proto.examplepb.camelCaseServiceName/Empty"
)
...
func RegisterCamelCaseServiceNameServer(s grpc.ServiceRegistrar, srv CamelCaseServiceNameServer) {
	// If the following call panics, it indicates UnimplementedCamelCaseServiceNameServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
var CamelCaseServiceName_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.camelCaseServiceName",
...
const (
	AnotherServiceWithNoBindings_NoBindings_FullMethodName = "/examples.internal.proto.examplepb.AnotherServiceWithNoBindings/NoBindings"
)
...
func RegisterAnotherServiceWithNoBindingsServer(s grpc.ServiceRegistrar, srv AnotherServiceWithNoBindingsServer) {
	// If the following call panics, it indicates UnimplementedAnotherServiceWithNoBindingsServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
var AnotherServiceWithNoBindings_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.AnotherServiceWithNoBindings",
...
const (
	SnakeEnumService_SnakeEnum_FullMethodName = "/examples.internal.proto.examplepb.SnakeEnumService/SnakeEnum"
)
...
func (UnimplementedSnakeEnumServiceServer) SnakeEnum(context.Context, *SnakeEnumRequest) (*SnakeEnumResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SnakeEnum not implemented")
}
...
func RegisterSnakeEnumServiceServer(s grpc.ServiceRegistrar, srv SnakeEnumServiceServer) {
	// If the following call panics, it indicates UnimplementedSnakeEnumServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
var SnakeEnumService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.SnakeEnumService",
