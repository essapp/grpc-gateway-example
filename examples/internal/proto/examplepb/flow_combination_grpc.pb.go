...
const (
	FlowCombination_RpcEmptyRpc_FullMethodName               = "/examples.internal.proto.examplepb.FlowCombination/RpcEmptyRpc"
	FlowCombination_RpcEmptyStream_FullMethodName            = "/examples.internal.proto.examplepb.FlowCombination/RpcEmptyStream"
	FlowCombination_StreamEmptyRpc_FullMethodName            = "/examples.internal.proto.examplepb.FlowCombination/StreamEmptyRpc"
	FlowCombination_StreamEmptyStream_FullMethodName         = "/examples.internal.proto.examplepb.FlowCombination/StreamEmptyStream"
	FlowCombination_RpcBodyRpc_FullMethodName                = "/examples.internal.proto.examplepb.FlowCombination/RpcBodyRpc"
	FlowCombination_RpcPathSingleNestedRpc_FullMethodName    = "/examples.internal.proto.examplepb.FlowCombination/RpcPathSingleNestedRpc"
	FlowCombination_RpcPathNestedRpc_FullMethodName          = "/examples.internal.proto.examplepb.FlowCombination/RpcPathNestedRpc"
	FlowCombination_RpcBodyStream_FullMethodName             = "/examples.internal.proto.examplepb.FlowCombination/RpcBodyStream"
	FlowCombination_RpcPathSingleNestedStream_FullMethodName = "/examples.internal.proto.examplepb.FlowCombination/RpcPathSingleNestedStream"
	FlowCombination_RpcPathNestedStream_FullMethodName       = "/examples.internal.proto.examplepb.FlowCombination/RpcPathNestedStream"
)
...
func (UnimplementedFlowCombinationServer) RpcPathSingleNestedStream(*SingleNestedProto, grpc.ServerStreamingServer[EmptyProto]) error {
	return status.Error(codes.Unimplemented, "method RpcPathSingleNestedStream not implemented")
}
func (UnimplementedFlowCombinationServer) RpcPathNestedStream(*NestedProto, grpc.ServerStreamingServer[EmptyProto]) error {
	return status.Error(codes.Unimplemented, "method RpcPathNestedStream not implemented")
}
...
func RegisterFlowCombinationServer(s grpc.ServiceRegistrar, srv FlowCombinationServer) {
	// If the following call panics, it indicates UnimplementedFlowCombinationServer was
...
var FlowCombination_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.FlowCombination",
