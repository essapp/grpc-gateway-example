...
const (
	Foo2Service_Foo2_FullMethodName = "/examples.internal.proto.examplepb.Foo2Service/Foo2"
)
...
func (UnimplementedFoo2ServiceServer) Foo2(context.Context, *Foo2Request) (*Foo2Reply, error) {
	return nil, status.Error(codes.Unimplemented, "method Foo2 not implemented")
}
...
func RegisterFoo2ServiceServer(s grpc.ServiceRegistrar, srv Foo2ServiceServer) {
	// If the following call panics, it indicates UnimplementedFoo2ServiceServer was
...
var Foo2Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.Foo2Service",
