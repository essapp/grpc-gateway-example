...
const (
	ResponseBodyService_GetResponseBody_FullMethodName         = "/examples.internal.proto.examplepb.ResponseBodyService/GetResponseBody"
	ResponseBodyService_ListResponseBodies_FullMethodName      = "/examples.internal.proto.examplepb.ResponseBodyService/ListResponseBodies"
	ResponseBodyService_ListResponseStrings_FullMethodName     = "/examples.internal.proto.examplepb.ResponseBodyService/ListResponseStrings"
	ResponseBodyService_GetResponseBodyStream_FullMethodName   = "/examples.internal.proto.examplepb.ResponseBodyService/GetResponseBodyStream"
	ResponseBodyService_GetResponseBodySameName_FullMethodName = "/examples.internal.proto.examplepb.ResponseBodyService/GetResponseBodySameName"
)
...
func (UnimplementedResponseBodyServiceServer) ListResponseBodies(context.Context, *ResponseBodyIn) (*RepeatedResponseBodyOut, error) {
	return nil, status.Error(codes.Unimplemented, "method ListResponseBodies not implemented")
}
func (UnimplementedResponseBodyServiceServer) ListResponseStrings(context.Context, *ResponseBodyIn) (*RepeatedResponseStrings, error) {
	return nil, status.Error(codes.Unimplemented, "method ListResponseStrings not implemented")
}
func (UnimplementedResponseBodyServiceServer) GetResponseBodyStream(*ResponseBodyIn, grpc.ServerStreamingServer[ResponseBodyOut]) error {
	return status.Error(codes.Unimplemented, "method GetResponseBodyStream not implemented")
}
func (UnimplementedResponseBodyServiceServer) GetResponseBodySameName(context.Context, *ResponseBodyIn) (*ResponseBodyValue, error) {
	return nil, status.Error(codes.Unimplemented, "method GetResponseBodySameName not implemented")
}
...
func RegisterResponseBodyServiceServer(s grpc.ServiceRegistrar, srv ResponseBodyServiceServer) {
	// If the following call panics, it indicates UnimplementedResponseBodyServiceServer was
...
var ResponseBodyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.ResponseBodyService",
