...
const (
	OpaqueEcommerceService_OpaqueGetProduct_FullMethodName             = "/examples.internal.proto.examplepb.OpaqueEcommerceService/OpaqueGetProduct"
	OpaqueEcommerceService_OpaqueSearchProducts_FullMethodName         = "/examples.internal.proto.examplepb.OpaqueEcommerceService/OpaqueSearchProducts"
	OpaqueEcommerceService_OpaqueProcessOrders_FullMethodName          = "/examples.internal.proto.examplepb.OpaqueEcommerceService/OpaqueProcessOrders"
	OpaqueEcommerceService_OpaqueStreamCustomerActivity_FullMethodName = "/examples.internal.proto.examplepb.OpaqueEcommerceService/OpaqueStreamCustomerActivity"
)
...
func (UnimplementedOpaqueEcommerceServiceServer) OpaqueGetProduct(context.Context, *OpaqueGetProductRequest) (*OpaqueGetProductResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method OpaqueGetProduct not implemented")
}
func (UnimplementedOpaqueEcommerceServiceServer) OpaqueSearchProducts(*OpaqueSearchProductsRequest, grpc.ServerStreamingServer[OpaqueSearchProductsResponse]) error {
	return status.Error(codes.Unimplemented, "method OpaqueSearchProducts not implemented")
}
func (UnimplementedOpaqueEcommerceServiceServer) OpaqueProcessOrders(grpc.ClientStreamingServer[OpaqueProcessOrdersRequest, OpaqueProcessOrdersResponse]) error {
	return status.Error(codes.Unimplemented, "method OpaqueProcessOrders not implemented")
}
func (UnimplementedOpaqueEcommerceServiceServer) OpaqueStreamCustomerActivity(grpc.BidiStreamingServer[OpaqueStreamCustomerActivityRequest, OpaqueStreamCustomerActivityResponse]) error {
	return status.Error(codes.Unimplemented, "method OpaqueStreamCustomerActivity not implemented")
}
...
func RegisterOpaqueEcommerceServiceServer(s grpc.ServiceRegistrar, srv OpaqueEcommerceServiceServer) {
	// If the following call panics, it indicates UnimplementedOpaqueEcommerceServiceServer was
...
var OpaqueEcommerceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.OpaqueEcommerceService",
