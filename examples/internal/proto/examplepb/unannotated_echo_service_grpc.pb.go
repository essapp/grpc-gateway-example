...
const (
	UnannotatedEchoService_Echo_FullMethodName       = "/examples.internal.proto.examplepb.UnannotatedEchoService/Echo"
	UnannotatedEchoService_EchoBody_FullMethodName   = "/examples.internal.proto.examplepb.UnannotatedEchoService/EchoBody"
	UnannotatedEchoService_EchoDelete_FullMethodName = "/examples.internal.proto.examplepb.UnannotatedEchoService/EchoDelete"
	UnannotatedEchoService_EchoNested_FullMethodName = "/examples.internal.proto.examplepb.UnannotatedEchoService/EchoNested"
)
...
func (UnimplementedUnannotatedEchoServiceServer) EchoBody(context.Context, *UnannotatedSimpleMessage) (*UnannotatedSimpleMessage, error) {
	return nil, status.Error(codes.Unimplemented, "method EchoBody not implemented")
}
func (UnimplementedUnannotatedEchoServiceServer) EchoDelete(context.Context, *UnannotatedSimpleMessage) (*UnannotatedSimpleMessage, error) {
	return nil, status.Error(codes.Unimplemented, "method EchoDelete not implemented")
}
func (UnimplementedUnannotatedEchoServiceServer) EchoNested(context.Context, *UnannotatedSimpleMessage) (*UnannotatedSimpleMessage, error) {
	return nil, status.Error(codes.Unimplemented, "method EchoNested not implemented")
}
...
func RegisterUnannotatedEchoServiceServer(s grpc.ServiceRegistrar, srv UnannotatedEchoServiceServer) {
	// If the following call panics, it indicates UnimplementedUnannotatedEchoServiceServer was
...
var UnannotatedEchoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.UnannotatedEchoService",
