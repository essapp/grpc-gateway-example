...
const (
	EchoService_Echo_FullMethodName             = "/examples.internal.proto.examplepb.EchoService/Echo"
	EchoService_EchoBody_FullMethodName         = "/examples.internal.proto.examplepb.EchoService/EchoBody"
	EchoService_EchoDelete_FullMethodName       = "/examples.internal.proto.examplepb.EchoService/EchoDelete"
	EchoService_EchoPatch_FullMethodName        = "/examples.internal.proto.examplepb.EchoService/EchoPatch"
	EchoService_EchoUnauthorized_FullMethodName = "/examples.internal.proto.examplepb.EchoService/EchoUnauthorized"
)
...
func (UnimplementedEchoServiceServer) EchoPatch(context.Context, *DynamicMessageUpdate) (*DynamicMessageUpdate, error) {
	return nil, status.Error(codes.Unimplemented, "method EchoPatch not implemented")
}
func (UnimplementedEchoServiceServer) EchoUnauthorized(context.Context, *SimpleMessage) (*SimpleMessage, error) {
	return nil, status.Error(codes.Unimplemented, "method EchoUnauthorized not implemented")
}
...
var EchoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.EchoService",
