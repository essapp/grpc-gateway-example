...
const (
	StreamService_BulkCreate_FullMethodName       = "/examples.internal.proto.examplepb.StreamService/BulkCreate"
	StreamService_List_FullMethodName             = "/examples.internal.proto.examplepb.StreamService/List"
	StreamService_BulkEcho_FullMethodName         = "/examples.internal.proto.examplepb.StreamService/BulkEcho"
	StreamService_BulkEchoDuration_FullMethodName = "/examples.internal.proto.examplepb.StreamService/BulkEchoDuration"
	StreamService_Download_FullMethodName         = "/examples.internal.proto.examplepb.StreamService/Download"
)
...
func (UnimplementedStreamServiceServer) BulkEcho(grpc.BidiStreamingServer[sub.StringMessage, sub.StringMessage]) error {
	return status.Error(codes.Unimplemented, "method BulkEcho not implemented")
}
func (UnimplementedStreamServiceServer) BulkEchoDuration(grpc.BidiStreamingServer[durationpb.Duration, durationpb.Duration]) error {
	return status.Error(codes.Unimplemented, "method BulkEchoDuration not implemented")
}
...
var StreamService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.StreamService",
