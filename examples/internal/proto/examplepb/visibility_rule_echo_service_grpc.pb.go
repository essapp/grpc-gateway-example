...
const (
	VisibilityRuleEchoService_Echo_FullMethodName                   = "/examples.internal.proto.examplepb.VisibilityRuleEchoService/Echo"
	VisibilityRuleEchoService_EchoInternal_FullMethodName           = "/examples.internal.proto.examplepb.VisibilityRuleEchoService/EchoInternal"
	VisibilityRuleEchoService_EchoPreview_FullMethodName            = "/examples.internal.proto.examplepb.VisibilityRuleEchoService/EchoPreview"
	VisibilityRuleEchoService_EchoInternalAndPreview_FullMethodName = "/examples.internal.proto.examplepb.VisibilityRuleEchoService/EchoInternalAndPreview"
)
...
func (UnimplementedVisibilityRuleEchoServiceServer) EchoInternal(context.Context, *VisibilityRuleSimpleMessage) (*VisibilityRuleSimpleMessage, error) {
	return nil, status.Error(codes.Unimplemented, "method EchoInternal not implemented")
}
func (UnimplementedVisibilityRuleEchoServiceServer) EchoPreview(context.Context, *VisibilityRuleSimpleMessage) (*VisibilityRuleMessageInPreviewMethod, error) {
	return nil, status.Error(codes.Unimplemented, "method EchoPreview not implemented")
}
func (UnimplementedVisibilityRuleEchoServiceServer) EchoInternalAndPreview(context.Context, *VisibilityRuleSimpleMessage) (*VisibilityRuleSimpleMessage, error) {
	return nil, status.Error(codes.Unimplemented, "method EchoInternalAndPreview not implemented")
}
...
func RegisterVisibilityRuleEchoServiceServer(s grpc.ServiceRegistrar, srv VisibilityRuleEchoServiceServer) {
	// If the following call panics, it indicates UnimplementedVisibilityRuleEchoServiceServer was
...
var VisibilityRuleEchoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.VisibilityRuleEchoService",
...
const (
	VisibilityRuleInternalEchoService_Echo_FullMethodName = "/examples.internal.proto.examplepb.VisibilityRuleInternalEchoService/Echo"
)
...
func RegisterVisibilityRuleInternalEchoServiceServer(s grpc.ServiceRegistrar, srv VisibilityRuleInternalEchoServiceServer) {
	// If the following call panics, it indicates UnimplementedVisibilityRuleInternalEchoServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
var VisibilityRuleInternalEchoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.VisibilityRuleInternalEchoService",
