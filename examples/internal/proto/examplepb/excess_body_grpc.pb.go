...
const (
	ExcessBodyService_NoBodyRpc_FullMethodName            = "/examples.internal.proto.examplepb.ExcessBodyService/NoBodyRpc"
	ExcessBodyService_NoBodyServerStream_FullMethodName   = "/examples.internal.proto.examplepb.ExcessBodyService/NoBodyServerStream"
	ExcessBodyService_WithBodyRpc_FullMethodName          = "/examples.internal.proto.examplepb.ExcessBodyService/WithBodyRpc"
	ExcessBodyService_WithBodyServerStream_FullMethodName = "/examples.internal.proto.examplepb.ExcessBodyService/WithBodyServerStream"
)
...
func (UnimplementedExcessBodyServiceServer) NoBodyRpc(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method NoBodyRpc not implemented")
}
func (UnimplementedExcessBodyServiceServer) NoBodyServerStream(*emptypb.Empty, grpc.ServerStreamingServer[emptypb.Empty]) error {
	return status.Error(codes.Unimplemented, "method NoBodyServerStream not implemented")
}
func (UnimplementedExcessBodyServiceServer) WithBodyRpc(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method WithBodyRpc not implemented")
}
func (UnimplementedExcessBodyServiceServer) WithBodyServerStream(*emptypb.Empty, grpc.ServerStreamingServer[emptypb.Empty]) error {
	return status.Error(codes.Unimplemented, "method WithBodyServerStream not implemented")
}
...
func RegisterExcessBodyServiceServer(s grpc.ServiceRegistrar, srv ExcessBodyServiceServer) {
	// If the following call panics, it indicates UnimplementedExcessBodyServiceServer was
...
var ExcessBodyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "examples.internal.proto.examplepb.ExcessBodyService",
